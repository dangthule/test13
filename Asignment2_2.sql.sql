...
deparment_id    TINYINT PRIMARY KEY AUTO_INCREMENT ,
deparment_name VARCHAR(50) NOT NULL UNIQUE
) ;

CREATE TABLE 'position'  (
position_id   TINY PRIMARY KEY AUTO_INCREMENT ,
...
deparment_id TINYINT,
-- CONSTRAINT FOREIGN KEY(deparment_id) REFERENCES 1department(deparment_id) ,
